...
const VERSION = 'motion-controller-shell-v1';
const ASSETS = ['./', './index.html', './styles.css', './motion-math.js', './controller.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png'];
